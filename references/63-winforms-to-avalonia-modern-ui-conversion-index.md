...
This reference lane maps Windows Forms application patterns to Avalonia 12 XAML/C# patterns, using the local Avalonia source baseline for API verification, for:
